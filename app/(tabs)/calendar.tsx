        ...
        {(selectedDateVisits.length > 0 || selectedDateFamilyVisits.length > 0) ? (
          <>
                ...
                >
                  ...
                  <View style={styles.visitInfo}>
                    <View style={styles.caregiverInfo}>
                      ...
                      <Text style={[styles.caregiverText, { color: colors.textSecondary }]}>
            ...
            {selectedDateFamilyVisits.map(familyVisit => (
              <View key={familyVisit.id} style={[styles.visitItem, styles.familyVisit, { backgroundColor: colors.surface }]}>
                <View style={styles.visitTime}>
                ...
                <View style={styles.visitInfo}>
                  ...
                  {familyVisit.notes && (
                    <Text style={[styles.familyNotes, { color: colors.textSecondary }]}>{familyVisit.notes}</Text>
                  )}
                </View>
              </View>
            ))}
          ...
          <View style={[styles.noVisits, { backgroundColor: colors.surface }]}>
            <Text style={[styles.noVisitsText, { color: colors.textSecondary }]}>Aucune visite prévue ce jour</Text>
          </View>
        )}
      </ScrollView>
