...
import { Visit, Event, Notification, FamilyVisit } from '@/types';
import { getInitialVisits, caregivers, events as initialEvents, notifications as initialNotifications, initialFamilyVisits } from '@/data/mockData';
...
interface VisitContextType {
  ...
  addFamilyVisit: (familyVisit: FamilyVisit) => void;
}
...
export function VisitProvider({ children }: { children: ReactNode }) {
  ...
  const [familyVisits, setFamilyVisits] = useState<FamilyVisit[]>(initialFamilyVisits);
  ...
  const resetVisits = () => {
    ...
    setFamilyVisits(initialFamilyVisits);
  };
